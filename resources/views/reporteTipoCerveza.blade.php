...
<head>
    ...
    <title>ACAVUCAB - Reporte Tipo de cerveza</title>
</head>
...
<body>
    ...
    <div class="container mt-2 pt-2">
        <h1 class="display-4 text-center">Tipo de cerveza más vendido por mes</h1>
        <hr class="bg-warning">

        <div class="col-md-8 order-md-1">
            <h4 class="mb-3">Indique Periodo de tiempo</h4>
            <form method="POST" action="{{ route('reporte.tipoCerveza') }}" validate>
                @csrf
