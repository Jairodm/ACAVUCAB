...
<body>
    ...
    <div >
        <a href = "register?tipoUsuario=1">
        <button
            style="position:absolute; top:25%; left:35%; height:100px; width:450px; font-size:30px; border-radius:20px;"
            type="button" class="btn btn-warning">Registrar cliente natural
        </button>
        </a>
