...
<body>
    ...
    <div class="container">
        ...
        <div class="container center_div">
            ...
            <form action="{{route ('aprobar.orden', $eyo->codigo_estatus)}}" class="needs-validation" method="POST" novalidate>
                ...
                <hr class="mb-4">
                    <button class="btn btn-warning  btn-lg " type="submit">Aprobar orden</button>
                    
            </form>
            <form action="{{route ('eliminar.ordenCompra',     $eyo->ordenCompra->codigo_orden_compra)}}" method="POST" class="d-inline">

                @method('DELETE')
                @csrf
                <button class="btn btn-warning btn-lg " style="background-color:red; color:white" type="submit">Cancelar orden de compra</button>
