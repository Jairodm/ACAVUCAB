...
<head>
    ...
    <title>ACAVUCAB - Proveedores</title>
</head>
            ...
            <table class="table table-hover">
                    <thead class="bg-warning">
                        <tr>
                            ...
                            <th scope="col" class="text-center">Denominación comercial</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <th class="text-center">{{$item->denominacion_comercial}}</th>
                            <td class="text-center"><a href="{{route('consultarProveedor', $item->rif_proveedor)}}" class="btn btn-warning" style="background-color: greenyellow" >Consultar datos</a></td>
                        </tr>
                             @endforeach
                    </tbody>
                </table>
