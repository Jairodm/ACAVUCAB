...
<body>
    ...
    <div class="container mt-2 pt-2">
        <h2 class="display-4 text-center">Asistencias </h2>
        <hr class="bg-warning">
            <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                                <th class="text-center">{{$item->fecha_asistencia}}</th>
                                <th class="text-center">{{$item->hora_entrada_asistencia}}</th>
                                <th class="text-center">{{$item->hora_salida_asistencia}}</th>
                        </tr>
                             @endforeach
                    </tbody>
                </table>
