...
<head>
    ...
    <title>ACAVUCAB - Consulta producto proveedor</title>
</head>
<body>
    ...
    <div class="container mt-2 pt-2">
                ...
                <form class="needs-validation" novalidate>
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" id="nombreCerveza" placeholder="" value="" required>                      
                    </div>
                    <div class="col-md-6 mb-3">
                            <label for="precioCerveza">Precio</label>
                             <input type="text" class="form-control" id="precioCerveza" placeholder="Monto en Bs." value="" required>                          
                        </div>
                </div>
                  ...
                  <div class="row">
                        <div class="col-md-6 mb-3">
                                ...
                                <br>
                                <select>
                                      <option value="V">Tipo 1</option>
                                      <option value="E">Tipo 2</option>
                                      <option value="E">Tipo 3</option>
                                    </select> 
                      </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-5 mb-3">
                          ...
                          <select class="custom-select d-block w-100" id="ingrediente" required>
                        ...
                        <div class="col-md-4 mb-3">
                          <label for="camtodad">Cantidad</label>
                          <input type="text" class="form-control" id="cantidad" placeholder="" value="" required>   
                        </div>
                        <div class="col-md-3 mb-3">
                          <label for="unidad">Unidad</label>
                          <select class="custom-select d-block w-100" id="unidad" required>
                            <option value="">Escoger...</option>
                            <option>mg</option>
                          </select>
                          <div class="invalid-feedback">
        ...
        <div class="container mt-4 pt-4">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row" class="text-center">Agua</th>
                            <td class="text-center">10</td>
                            <td class="text-center">ml</td>
                            <td class="text-center">Eliminar ingrediente</td>
                        </tr>
                        <tr>
                            <th scope="row" class="text-center">Azucar</th>
            ...
            <button style="margin-bottom:50px"type="button" class="btn btn-warning">Guardar cambios</button>
    </div>
