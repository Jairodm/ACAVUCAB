...
<body>
    ...
    <div class="container mt-2 pt-2">
        ...
        <div class="col-md-8 order-md-1">
                ...
                <form method="POST" action="{{ route('registrar.rol') }}" validate>
                    @csrf
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <label for="segundoNombreEmpleado">Nombre</label>
                      <input type="text" class="form-control" name="nombre_rol" placeholder="" value="" >                    
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="segundoNombreEmpleado">URL</label>
                        <input type="text" class="form-control" name="slug_rol" placeholder="" value="" >                    
                      </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" name="descripcion_rol" placeholder="" value="" >
                    </div>
                  </div> 
