...
<head>
    ...
    <title>ACAVUCAB - ¿Olvido contrasena?</title>
                ...
                <div class="text-center" >
                  ...
                  <div class="panel-body">
                    ...
                    <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                      ...
                      <div class="form-group">
                        <input name="recover-submit" class="btn btn-lg btn-warning btn-block" value="Recuperar contraseña" type="submit">
                      </div>
