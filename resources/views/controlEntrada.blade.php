...
<head>
    ...
    <title>ACAVUCAB - Control de Entrada</title>
</head>
...
<body>
    ...
    <div class="container mt-2 pt-2">
        <h2 class="display-4 text-center">Control de Entrada </h2>
        <hr class="bg-warning">
            <table class="table table-hover">
                    <thead class="bg-warning">
                        <tr>
                            ...
                            <th scope="col" class="text-center">Días de trabajo a la semana</th>
                    ...
                    <tbody>
                        <tr>
                            <th scope="row" class="text-center">26647304</th>
                            <td class="text-center">José Manuel</td>
                            <td class="text-center">Gerente</td>
                            <td class="text-center">5</td>
                            <td class="text-center">7:00 AM</td>
                            <td class="text-center">5:00 PM</td>
                        </tr>
                    </tbody>
                </table>
    </div>
