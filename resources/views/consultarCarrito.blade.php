...
<head>
    ...
    <title>ACAVUCAB - Consulta de carrito</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="container center_div">
            ...
            <form action="{{route ('editar.carrito', $carrito->codigo_carrito)}}" class="needs-validation" method="POST" novalidate>

                @method('PUT')
                @csrf
        
                        <div class="col-md-6 mb-3">
                            <label for="vencimiento">Producto:</label>
                            <input type="text" class="form-control" name="nombre"  value="{{$carrito->cerveza->nombre_cerveza}}" placeholder="" readonly>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="vencimiento">Precio unitario:</label>
                            <input type="text" class="form-control" name="apellido"  value="{{$carrito->cerveza->precio}}" placeholder="" readonly>
                            <div class="invalid-feedback">
                                Valor requerido
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="vencimiento">Cantidad en carrito</label>
                            <input type="text" class="form-control" name="cantidad"  value="{{$carrito->cantidad}}" placeholder="" required>
                            <div class="invalid-feedback">
                                Valor requerido
                            </div>
