...
<head>
    ...
    <title>ACAVUCAB - Catálogo del proveedor</title>
</head>
...
<body>
    ...
    <div class="container mt-2 pt-2">
        <h2 class="display-4">Mis cervezas</h2>
        <hr class="bg-warning">
            <ul class="list-unstyled">
                    <li class="media">
                        <a href="ConsultarProductoProveedor"><img src="Cerveza5.jpg" class="mr-3" alt="" style="height: 150px; width: 120px"></a>                      <div class="media-body">
                        <a href="ConsultarProductoProveedor" style="color:black;"><h4 class="mt-0 mb-1">Título de cerveza</h4></a>
                    ...
                    <hr class="bg-warning">
                    <li class="media my-4">
                        <a href="ConsultarProductoProveedor"><img src="Cerveza5.jpg" class="mr-3" alt="" style="height: 150px; width: 120px"></a>
                    ...
                    <hr class="bg-warning">
                    <li class="media">
                            <a href="ConsultarProductoProveedor" style="text-decoration:none"><img src="Cerveza5.jpg" class="mr-3" alt="" style="height: 150px; width: 120px"></a>                        <div class="media-body">
                            <a href="ConsultarProductoProveedor" style="color:black;"><h4 class="mt-0 mb-1">Título de cerveza</h4></a>
                            Descripcion de la cerveza
                            <h6>Precio: 5555 BS </h6>
                            <h6>Cantidad en stock: 555</h6>
