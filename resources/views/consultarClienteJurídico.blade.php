      ...
      <form class="needs-validation" novalidate>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="rifJuridico" placeholder="" value="" readonly>
          </div>
          <div class="col-md-6 mb-3">
            <label for="capitalJuridico">Capital disponible</label>
            <input type="text" class="form-control" id="capitalJuridico" placeholder="" value="">
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="direccionWeb" placeholder="" value="">
          </div>

          <div class="col-md-6 mb-3">
            <label for="numerosTelefonicos">Números telefónicos</label>
            <input type="text" class="form-control" id="numerosTelefonicos" placeholder="Ej: 02125552323, 04147773344, ..."
              value="" required>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            <label for="correoJuridico">Correo Electronico</label>
            <input type="text" class="form-control" id="correoJuridico" placeholder="" value="" readonly>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="password" class="form-control" id="puntosJuridico" placeholder="" value="" readonly>
          </div>
        </div>
        ...
        <a href="ConsultarMetodosDePago">
          <button style="margin-right:30px; margin-bottom: 50px" type="button" class="btn btn-warning">Métodos de
          pago</button></a>
        <button style="background-color: greenyellow; margin-bottom: 50px" type="button" class="btn btn-warning">Guardar
          cambios</button>
    </div>
