...
<head>
    ...
    <title>ACAVUCAB - Presupuestos</title>
</head>
...
<div class="container mt-2 pt-2">
            <h4 class="display-7 text-center"><i class="fas fa-envelope-open-text"></i> Presupuesto</h4>
            ...
            <hr class="bg-warning">
                <ul class="list-unstyled">
                      ...
                      <button class="btn btn-warning">Añadir producto</button>
                      <button class="btn btn-warning float-right">Descargar presupuesto</button>
</div>
        <!-- Pagination -->
