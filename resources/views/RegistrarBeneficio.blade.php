            ...
            <h1 class="display-4 text-center">Beneficio</h1>
             <hr class="bg-warning">
                ...
                <div class="container center_div">
                    ...
                    <form method="POST" action="{{ route('registrar.beneficio', $empleado->cedula_empleado) }}" validate>
                        @csrf
                  ...
                  <hr class="mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" name="tipoBeneficio" placeholder="" required>
                    ...
                    <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="descripcionBeneficio" placeholder="" required>
                            <div class="invalid-feedback">
                              Valor requerido
                            </div>
