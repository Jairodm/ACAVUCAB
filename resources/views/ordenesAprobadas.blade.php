...
<head>
    ...
    <title>ACAVUCAB - Órdenes aprobadas</title>
</head>
...
<body>
    ...
    <div class="container mt-2 pt-2">
        <h2 class="display-4 text-center">Órdenes aprobadas</h2>
        <hr class="bg-warning">
            ...
            <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <td class="text-center"><a href="{{route('recibirOrden', $item->codigo_estatus)}}" class="btn btn-warning" style="background-color: greenyellow" >Declarar recepción</a></td>
                        </tr>
                             @endforeach
                    </tbody>
                </table>
