...
<div class="container mt-2 pt-2">
            <h4 class="display-7 text-center"><i class="fas fa-check"></i> Compra procesada exitosamente!</h4>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-warning">Descargar factura</button>
        </div>
      </div>
    </div>
  </div>
