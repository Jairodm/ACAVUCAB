...
<head>
    ...
    <title>ACAVUCAB - Registrar Tipo de Cerveza</title>
</head>
...
<body>
    ...
    <div class="container mt-2 pt-2">
            <h2 class="display-4 text-center">Registrar Tipo De Cerveza</h2>
            <hr class="bg-warning"> 
                ...
                <form class="needs-validation" novalidate>
                  <div class="row">
                    <div class="col-md-5 mb-3">
                      ...
                      <input type="text" class="form-control" id="familia" placeholder="" value="" required>
                  ...
                  <div class="row">
                    <div class="col-md-5 mb-3">
                      ...
                      <select class="custom-select d-block w-100" id="selectcaracteristica" required>
                        <option value="">...</option>
                        <option>Aroma:</option>
                        <option>Sabor:</option>
                        <option>Apariencia:</option>
                      </select>
                      <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mb-3 align-self-end">
                            <input type="text" class="form-control" id="caracteristica" placeholder="" value="" required>
                            <div class="invalid-feedback">
                              Valid first name is required.
                            </div>
                    </div>
                  ...
                  <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="comentario" placeholder="Cervezaaa" required>
                        <div class="invalid-feedback">
