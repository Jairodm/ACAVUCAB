...
<head>
    ...
    <title>ACAVUCAB - Control de Inventario</title>
</head>
...
<body>
    ...
    <div class="container mt-2 pt-2">
        <h2 class="display-4 text-center">Inventario </h2>
        <hr class="bg-warning">
            <table class="table table-hover">
                    <thead class="bg-warning">
                        <tr>
                            ...
                            <th scope="col" class="text-center">Cantidad del movimiento</th>
                            <th scope="col" class="text-center">Cantidad en Stock</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                                <th class="text-center">{{$item->fecha_operacion}}</th>
                                <th class="text-center">{{$item->cerveza->nombre_cerveza}}</th>
                                <th class="text-center">{{$item->cantidad_operacion}}</th>
                                <th class="text-center">{{$item->cantidad_disponible}}</th>
                                <?php
                                    if ($item->fk_venta){
