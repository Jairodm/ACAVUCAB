...
<head>
    ...
    <title>ACAVUCAB - Registrar Beneficio</title>
...
<body>
    ...
    <div class="container">
            <h1 class="display-4 text-center">Horario</h1>
             <hr class="bg-warning">
      
            
                <div class="container center_div">
              
                    <form method="POST" action="{{ route('registrar.horario') }}" validate>
                        @csrf
                  ...
                  <hr class="mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                      <label for="vencimiento">Día de la semana:</label>
                      <select class="custom-select d-block w-100" name="diaSemana" required>
                        <option> Lunes</option>
                    ...
                    <div class="col-md-6 mb-3">
                            <label for="vencimiento">Hora de llegada:</label>
                            <input type="time" class="form-control" name="horaLlegada" placeholder="" required>
                    ...
                    <div class="col-md-6 mb-3">
                            <label for="vencimiento">Hora de salida:</label>
                            <input type="time" class="form-control" name="horaSalida" placeholder="" required>
                            <div class="invalid-feedback">
                              Valor requerido
                            </div>
                  ...
                  <div class="col md-4 text-center">
                        <button class="btn btn-warning btn-lg " type="submit">Registrar horario</button>
                        </div>
                </form>
