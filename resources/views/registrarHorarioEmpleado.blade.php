...
<body>
    ...
    <div class="container">
            <h1 class="display-4 text-center">Agregar horario</h1>
             <hr class="bg-warning">
      
            
                <div class="container center_div">
              
                    <form method="POST" action="{{ route('registrar.horarioEmpleado', $empleado->cedula_empleado) }}" validate>
                        @csrf
                  ...
                  <hr class="mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                      <label for="vencimiento">Horario</label>
                      <br>
                                       <select class="custom-select d-block w-100" name="opcionSelect" required>
                                        
                                        @foreach ($horario as $item)
                                          
                                          <option>{{$item->dia .  ' '  . $item->hora_entrada .  ' ' . $item->hora_salida}}</option>
                                        @endforeach
                                      </select>        
                  ...
                  <div class="col md-4 text-center">
                        <button class="btn btn-warning btn-lg " type="submit">Agregar horario al empleado</button>
                        </div>
                </form>
