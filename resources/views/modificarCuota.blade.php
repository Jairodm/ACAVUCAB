...
<body>
    ...
    <div class="container">
        ...
        <div class="container center_div">
            ...
            <form action="{{route ('editar.cuotaAfiliacion', $cuota->codigo_cuota)}}" class="needs-validation" method="POST" novalidate>
                ...
                <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" value="{{$cuota->monto_cuota}}" name="monto" placeholder="" required>
                        <div class="invalid-feedback">
                          Valor requerido
                        </div>
            ...
            <form action="{{route ('eliminar.cuotaAfiliacion', $cuota->codigo_cuota)}}" method="POST" class="d-inline">

                @method('DELETE')
                @csrf
                <button class="btn btn-warning btn-lg " style="background-color:red; color:white" type="submit">Eliminar cuota</button>
