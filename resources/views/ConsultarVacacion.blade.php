...
<head>
    ...
    <title>ACAVUCAB - Consulta de vacaciones</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="container center_div">
            ...
            <form action="{{route ('editar.vacacion', $vacacion->codigo_vacacion)}}" class="needs-validation" method="POST" novalidate>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control" name="fechaInicio"  value="{{$vacacion->fecha_inicio_vacacion}}" placeholder="" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control" name="fechaFin"  value="{{$vacacion->fecha_fin_vacacion}}" placeholder="" required>
                    <div class="invalid-feedback">
                        Valor requerido
                    </div>
            ...
            <form action="{{route ('eliminar.vacacion',     $vacacion->codigo_vacacion)}}" method="POST" class="d-inline">

                @method('DELETE')
                @csrf
                <button class="btn btn-warning btn-lg " style="background-color:red; color:white" type="submit">Eliminar vacacion</button>
