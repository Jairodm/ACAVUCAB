...
<head>
    ...
    <title>ACAVUCAB - Confirmar pago</title>
</head>
...
<body>
        <nav class="navbar navbar-expand-lg bg-warning navbar-light sticky-top">
            ...
            <div class="container">
                <h1 class="display-4 text-center">Resumen del pago</h1>
                 <hr class="bg-warning">
          
                
                    <div class="container center_div">
                  
                        <form method="POST" action="{{ route('cuotaProcesada', [$codigo_metodo_pago, $monto_cuota, $codigo_cuota] ) }}" validate>
                            @method('PUT')
                            @csrf
                      ...
                      <div class="col md-4 text-center">
                        <button type="submit" class="btn btn-warning">Procesar pago</button>
                            </div>
                    </form>
