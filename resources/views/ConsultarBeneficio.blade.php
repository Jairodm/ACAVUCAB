...
<body>
    ...
    <div class="container">
        ...
        <div class="container center_div">
            ...
            <form action="{{route ('editar.beneficio', $beneficio->codigo_beneficio)}}" class="needs-validation" method="POST" novalidate>
                ...
                @csrf
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="tipoBeneficio"  value="{{$beneficio->tipo_beneficio}}" placeholder="" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="descripcionBeneficio"  value="{{$beneficio->descripcion_beneficio}}" placeholder="" required>
                            <div class="invalid-feedback">
                                Valor requerido
                            </div>
            ...
            <form action="{{route ('eliminar.beneficio',     $beneficio->codigo_beneficio)}}" method="POST" class="d-inline">

                @method('DELETE')
                @csrf
                <button class="btn btn-warning btn-lg " style="background-color:red; color:white" type="submit">Eliminar beneficio</button>
