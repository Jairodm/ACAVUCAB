...
<head>
    ...
    <title>ACAVUCAB - Listado de ordenes</title>
</head>
...
<body>
    ...
    <div class="container mt-2 pt-2">
        <h1 class="display-4 text-center">Listado de ordenes</h1>
        <hr class="bg-warning">

        <div class="col-md-8 order-md-1">
            <h4 class="mb-3">Indique Periodo de tiempo</h4>
            <form method="POST" action="{{ route('reporte.listaordenes') }}" validate>
                @csrf
