...
<body>
    ...
    <div class="container mt-2 pt-2">
        <h2 class="display-4">Nuestros eventos</h2>
        <hr class="bg-warning">
            <ul class="list-unstyled">
                    <li class="media">
                        <a href="consultarEvento"><img src="Cerveza5.jpg" class="mr-3" alt="" style="height: 150px; width: 120px"></a>                      <div class="media-body">
                        <a href="consultarEvento" style="color:black;"><h4 class="mt-0 mb-1">Título del evento</h4></a>
                        Descripcion del evento
                        <h6>Precio entrada: 5555 BS </h6>
                        <h6>Fecha: 10/12/2019</h6>
                      </div>
                      <!-- Aquí habría que incluir el caso de que el empleado vaya a modificar el evento
                            con href="ConsultarEventoEmpleado" -->
                    </li>
                    <hr class="bg-warning">
                    <li class="media my-4">
                        <a href="consultarEvento"><img src="Cerveza5.jpg" class="mr-3" alt="" style="height: 150px; width: 120px"></a>
                    ...
                    <hr class="bg-warning">
                    <li class="media">
                            <a href="consultarEvento" style="text-decoration:none"><img src="Cerveza5.jpg" class="mr-3" alt="" style="height: 150px; width: 120px"></a>                        <div class="media-body">
                            <a href="consultarEvento" style="color:black;"><h4 class="mt-0 mb-1">Título del evento</h4></a>
                            Descripcion del evento
                        <h6>Precio entrada: 5555 BS </h6>
                        <h6>Fecha: 10/12/2019</h6>
